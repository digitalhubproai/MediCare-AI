...
import { Stethoscope, Mail, Lock, User, ArrowRight, CheckCircle, Eye, EyeOff, Shield, Github } from "lucide-react"
      ...
      <div className="w-full lg:w-[45%] flex items-center justify-center p-6 md:p-12 relative">
        <div className="w-full max-w-md">
          ...
          >
            ...
            <p className="text-slate-600">Start your journey to better health</p>
          </motion.div>
        ...
        <div className="relative z-10 flex flex-col justify-between w-full p-16">
          ...
          <div className="space-y-8">
            ...
            <h1 className="text-5xl font-bold text-white leading-tight">
              Start Your <br />
              <span className="text-cyan-300">Health Journey</span>
            </h1>

            <p className="text-lg text-blue-100 max-w-md">
              Get instant access to AI-powered health consultations, report analysis, and personalized wellness tracking.
            </p>

            {/* Features */}
            <div className="space-y-4">
              {[
                { icon: CheckCircle, text: "Free 14-day Pro trial" },
          ...
          <div className="p-6 rounded-2xl bg-white/10 backdrop-blur-sm border border-white/20">
            ...
            <p className="text-white/90 mb-4 leading-relaxed">
              &quot;MediCare AI has completely transformed how I manage my health. The insights are incredibly accurate!&quot;
            </p>
